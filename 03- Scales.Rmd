...
ggplot(mpg, aes(displ, hwy)) +
  geom_point() +
  scale_y_continuous(quote(hwy~~phantom(1)~~bgroup("{",frac(Miles,Gallon),"}")))
```
...
In the above graph, the legends don't show the black dots and therefore there is a mismatch
between the points in the graph and the legend. You can switch on show.legend option in the first geom_point layer
...
## Controlling legend position using theme(). We will learn more about themes in the next class.
